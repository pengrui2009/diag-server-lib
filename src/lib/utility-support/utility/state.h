 ...
 */
#ifndef DIAGNOSTIC_SERVER_LIB_LIB_UTILITY_UTILITY_STATE_H
#define DIAGNOSTIC_SERVER_LIB_LIB_UTILITY_UTILITY_STATE_H
...
#endif  // DIAGNOSTIC_SERVER_LIB_LIB_UTILITY_UTILITY_STATE_H