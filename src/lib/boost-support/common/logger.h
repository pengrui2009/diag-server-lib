 ...
 */
#ifndef DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_COMMON_LOGGER_H
#define DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_COMMON_LOGGER_H
...
#endif  // DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_COMMON_LOGGER_H
