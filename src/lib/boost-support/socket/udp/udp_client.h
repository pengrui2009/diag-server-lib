 ...
 */
#ifndef DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_UDP_UDP_CLIENT_H
#define DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_UDP_UDP_CLIENT_H
...
#endif  // DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_UDP_UDP_CLIENT_H
