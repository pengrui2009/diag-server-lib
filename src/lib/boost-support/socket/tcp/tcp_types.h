...
*/
#ifndef DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_TCP_TCP_TYPES_H
#define DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_TCP_TCP_TYPES_H
...
#endif  // DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_TCP_TCP_TYPES_H
