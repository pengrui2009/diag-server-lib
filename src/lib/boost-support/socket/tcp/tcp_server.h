...
*/
#ifndef DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_TCP_TCP_SERVER_H
#define DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_TCP_TCP_SERVER_H
...
#endif  // DIAGNOSTIC_SERVER_LIB_LIB_BOOST_SUPPORT_SOCKET_TCP_TCP_SERVER_H
