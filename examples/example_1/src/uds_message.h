...
class UdsMessage final : public diag::server::uds_message::UdsMessage {
public:
  // ctor
  UdsMessage(std::string_view host_ip_address, diag::server::uds_message::UdsMessage::ByteVector payload)
...
private:
  ...
  diag::server::uds_message::UdsMessage::ByteVector uds_payload_;

  const diag::server::uds_message::UdsMessage::ByteVector &GetPayload() const override { return uds_payload_; }

  // return the underlying buffer for write access
  diag::server::uds_message::UdsMessage::ByteVector &GetPayload() override { return uds_payload_; }
